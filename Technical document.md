...
The MCQ Generator is a Chrome extension that transforms webpage content into interactive multiple-choice questions using OpenAI's GPT-4o models. This document explains the workflow of the extension.
